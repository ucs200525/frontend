...
const Reports = ({ uid }) => {
  ...
  const fetchReports = async () => {
    try {
      const response = await axios.get(`https://ecs-backend-xsuv.onrender.com/api/reports/by-uid/${uid}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`https://ecs-backend-xsuv.onrender.com/api/reports/by-uid/${uid}`, formData, {
        headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axios.put(`https://ecs-backend-xsuv.onrender.com/api/reports/by-uid/${uid}/${editingReportId}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://ecs-backend-xsuv.onrender.com/api/reports/by-uid/${uid}/${id}`);
      ...
      <ul>
        {reports.map((report) => (
          <li key={report._id}>
            ...
            <a href={`https://ecs-backend-xsuv.onrender.com/api/reports/${encodeURIComponent(report.fileName)}`} target="_blank" rel="noopener noreferrer">
  <button>Open</button>
</a>
...
//             <button onClick={() => handleEdit(report)}>Edit</button>
//             <button onClick={() => handleDelete(report._id)}>Delete</button>
//             <a href={`https://ecs-backend-xsuv.onrender.com/${report.filePath}`} target="_blank" rel="noopener noreferrer">
//               <button>Open</button>
//             </a>
//             <a>
//             <button onClick={() => window.open(`https://ecs-backend-xsuv.onrender.com/api/reports/${report.filePath}`)} target="_blank" rel="noopener noreferrer" ></button>
//               <button>Open</button>
//             </a>
//           </li>
//         ))}
