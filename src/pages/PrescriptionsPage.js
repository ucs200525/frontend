...
const Prescriptions = ({ uid }) => {
  ...
  useEffect(() => {
    const fetchPrescriptions = async () => {
      try {
        const response = await axios.get(`https://ecs-backend-xsuv.onrender.com/api/prescriptions/by-uid/${uid}`);
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingPrescription) {
      // Update prescription
      try {
        await axios.put(`https://ecs-backend-xsuv.onrender.com/api/prescriptions/by-uid/${uid}`, formData);
      ...
      try {
        const response = await axios.post(`https://ecs-backend-xsuv.onrender.com/api/prescriptions/by-uid/${uid}`, formData);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://ecs-backend-xsuv.onrender.com/api/prescriptions/by-uid/${uid}`);
